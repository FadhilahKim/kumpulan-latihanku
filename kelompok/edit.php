...
if (isset($_POST['simpan'])) {
  ...
  $hasil = $_FILES['hasil']['name'];
  $ukuran = $_FILES['hasil']['size'];
  $file_tmp = $_FILES['hasil']['tmp_name'];

  move_uploaded_file($file_tmp, 'assets/images/' . $hasil);
  $update = mysqli_query($koneksi, "UPDATE pesanan SET crud_nama='$nama', crud_emali='$email', crud_telp='$telp', crud_kategori='$kategori', crud_gambar='$namafile', crud_deskripsi='$deskripsi', crud_waktu='$waktu', crud_konfirmasi='$konfirmasi',crud_hasil='$hasil', crud_pembayaran='$pembayaran' WHERE crud_id='$_GET[id]'") or die(mysqli_error($koneksi));
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <table cellpadding="3" cellspacing="0">
                ...
                <tr>
                  <td>Status</td>
                  <td>:</td>
                  <td><input type="text" name="konfirmasi" size="30" value="<?php
                                                                            echo $data['crud_konfirmasi']; ?>"></td>
                <tr>
                <tr>
                  <td>Hasil</td>
                  <td>:</td>
                  <td><input type="file" name="hasil" size="30" value="<?php
                                                                        echo $data['crud_hasil']; ?>"></td>
                <tr>
