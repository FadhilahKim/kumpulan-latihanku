                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php
                            echo '<h1>Email</h1>';
                            echo '<input type="text" readonly value="' . $data['email'] . '" class="form-control form-control-user" required>';
                            echo '<h1>Nama</h1>';
                            echo '<input type="text" readonly value="' . $data['nama'] . '" class="form-control form-control-user" required>';
                            echo '<h1>Password</h1>';
                            echo '<input type="text" readonly value="' . $data['password'] . '" class="form-control form-control-user" required>';
                            echo '<h1>Level</h1>';
                            echo '<input type="text" readonly value="' . $data['level'] . '" class="form-control form-control-user" required>';
                            ?>
                        </div>
                    </div>
